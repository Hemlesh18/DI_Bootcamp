...
-- )
-- insert into student (first_name,last_name,birth_date) Values ('Marc','Benichou','02/11/1998'),('Yoan','Cohen','03/12/2010'),('Lea','Benichou','27/07/1987'),('Amelia','Dux','07/04/1996'),('David','Grez','14/06/2003'),('Omer','Simpson','03/10/1980');
-- SELECT *FROM student
...
-- SELECT first_name , last_name FROM student where last_name ilike '%benichou' or  first_name ilike'%marc'
